      ...
      <section className="border-t border-ink/15 bg-cream pb-24 pt-12 dark:border-cream/15 dark:bg-ink md:pb-28">
        <Container className="flex flex-col items-start gap-6">
          <Reveal className="reveal-instant flex w-full items-center gap-5">
            <h2 className="font-display shrink-0 text-3xl text-ink dark:text-cream md:text-4xl">Coming Soon</h2>
            <span className="h-1 flex-1 bg-accent" />
          </Reveal>
          <Reveal delay={0.1} className="reveal-instant">
            <p className="max-w-2xl text-base leading-relaxed text-ink/65 dark:text-cream/65">
