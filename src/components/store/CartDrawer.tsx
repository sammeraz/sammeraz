      ...
      {isOpen ? (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-y-0 right-0 z-[101] flex w-full max-w-md flex-col bg-cream text-ink shadow-2xl"
          >
            <div className="flex items-center justify-between border-b border-ink/15 px-6 py-5">
              ...
              <motion.button
                ...
                className="flex h-9 w-9 items-center justify-center text-ink/60 transition-colors hover:text-ink"
              >
            ...
            {items.length === 0 ? (
              ...
              <>
                    ...
                    {items.map((item) => (
                      <li key={item.slug} className="flex gap-4">
                        ...
                        <div className="flex flex-1 flex-col gap-1">
                          ...
                          <p className="text-xs uppercase tracking-[0.08em] text-ink/50">
                            {item.issue}
                          </p>
                          ...
                          <button
                            ...
                            className="mt-1 self-start text-xs text-ink/40 underline underline-offset-4 hover:text-accent"
                          >
                            Remove
                          </button>
                        </div>
                ...
                <div className="border-t border-ink/15 px-6 py-6">
                  ...
                  <p className="mt-1 text-xs text-ink/45">Shipping and tax calculated at checkout.</p>
